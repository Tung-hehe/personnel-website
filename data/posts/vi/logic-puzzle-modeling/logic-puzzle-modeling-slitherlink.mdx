...
ở đây ta sẽ mô hình hóa một phần của điều kiện và sử dụng một thuật toán được nêu ở mục [2.4](/blog/logic_puzzle_modeling_slitherlink#24-triển-khai-bài-toán)
