...
và đường màu xanh lá là một đường đi từ ô màu cam đến tâm. ![galaxies-objects](/posts/GalaxiesObjects.png)
...
*Code mô hình hóa Galaxies bằng python có tại [Tung-hehe/LogicPuzzlesSolver/galaxies](https://github.com/Tung-hehe/LogicPuzzlesSolver/blob/main/src/puzzles/galaxies.py).*
