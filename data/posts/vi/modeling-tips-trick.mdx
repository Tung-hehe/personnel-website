...
- Trong các bài viết tiếp theo mình sẽ gọi tắt kỹ thuật này là **phương pháp hình học**
...
```
Tạo thêm biến nhị phân $z$ thỏa mãn
...
tại [MOSEK Modeling Cookbook](https://docs.mosek.com/modeling-cookbook/index.html).
