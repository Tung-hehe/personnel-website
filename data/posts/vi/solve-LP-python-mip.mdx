...
image: /posts/solve_lp_python_mip/thumbnail.svg
authors: [default]
---
...
model = mip.Model()
```
Mô hình với cấu hình mặc định có hàm mục tiêu là *Minimize* và solver sử dụng là
...
Dưới đây là kết quả khi chạy đoạn code trên với nghiệm tối ưu là $x = 0$, $y = 5$,
