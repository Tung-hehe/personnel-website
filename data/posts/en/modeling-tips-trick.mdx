...
image: /posts/modeling_tips_tricks/thumbnail.svg
authors: [default]
---
...
For instance, given an integer variable $x \in \mathbb{Z}$ with the condition $0 \leq x \leq 9$,
...
On the other hand, if we decompose both $x$ and $y$ into binary variables, this condition
...
```
Create binary variable $z$ satisfying
