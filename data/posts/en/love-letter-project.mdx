...
The project ships with 11 templates, each with its own color palette and mood.
The letter's content stays the same - just switch templates to get a
...
<LoveLetterDemo templates={[
  ...
  { slug: 'mua_nho', label: 'Rainy Longing' },
  { slug: 'ngay_nho', label: 'Longing Days' },
]} />
