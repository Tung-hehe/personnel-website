...
## 3. Conclusion
For more Star Battle puzzles and variations, please refer to [Krazydad/start-battle](https://krazydad.com/starbattle/).

*The Python code for Star Battle modeling is available at
[Tung-hehe/LogicPuzzlesSolver/startBattle](https://github.com/Tung-hehe/LogicPuzzlesSolver/blob/main/src/puzzles/starBattle.py).*
