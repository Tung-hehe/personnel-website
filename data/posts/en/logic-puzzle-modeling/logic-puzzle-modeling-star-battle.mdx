...
Tham khảo thêm các câu đố Star Battle và biến thể tại [Krazydad/start-battle](https://krazydad.com/starbattle/).

*Code mô hình hóa Star Battle bằng python có tại [LogicPuzzlesSolver/startBattle](https://github.com/Tung-hehe/LogicPuzzlesSolver/blob/main/src/puzzles/starBattle.py).*
